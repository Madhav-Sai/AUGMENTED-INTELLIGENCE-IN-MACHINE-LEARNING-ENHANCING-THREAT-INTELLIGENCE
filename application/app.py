...
def classify(features):
    ...
    if proba_risk >0.2: risk = ["<p style=\"color:red;\">Very High</p>"]
    elif proba_risk >0.4: risk = ["<p style=\"color:orangered;\">High</p>"]
    if proba_risk >0.6: risk = ["<p style=\"color:orange;\">Medium</p>"]
    if proba_risk >0.8: risk = ["<p style=\"color:green;\">Low</p>"]
    else: risk = ["<p style=\"color:orangered;\">High</p>"]
...
def flow_detail():
    ...
    else: risk = "Risk: <p style=\"color:orangered;\">High</p>"
